...
| 레버리지 | 4x (고정) |
| 손절 (SL) | 진입가 ±2.5% (거래소 SL) + ±3.0% (봇 루프 Hard SL) |
| 1차 익절 (TP1) | 진입가 ±3.0% (RR = 1:1.2) |
...
TP_RATIO        = 1.2          # TP 비율 (SL_PCT × TP_RATIO = 3.0%)
